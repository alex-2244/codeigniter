...
<body class="offline-doc">
  ...
  <div class="page-header clear-filter">
    <div class="page-header-image" style="background-image: url('<?php echo  base_url(); ?>assets/img/cover.jpg');"></div>
  ...
  <footer class="footer">
    <div class="container-fluid">
      ...
      <div class="copyright float-right">
        ...
        <a href="https://www.creative-tim.com" target="_blank">Naveen</a> for a better web.
      </div>
    </div>
  </footer>
  <!--   Core JS Files   -->
